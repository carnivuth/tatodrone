...
class Controls{
  ...
  constructor(){
    ...
    this.camera_x_ctrl=this.gui.add({camera_x: 30}, 'camera_x', 0, 1000);
    this.camera_y_ctrl=this.gui.add({camera_y: 30}, 'camera_y', 0, 1000);
    this.camera_z_ctrl=this.gui.add({camera_z: 30}, 'camera_z', 0, 1000);
